...
contract MajesticOwl is ERC721Enumerable, Ownable {
    ...
    /// @notice Update Investor address
    /// @param _newAddress New address for Investor
    function setInvestor(address _newAddress) public onlyOwner {
        investor = payable(_newAddress);
    }
    ...
    /// @param _newAddress New address for Payments
    function setPayments(address _newAddress) public onlyOwner {
        payments = payable(_newAddress);
    }
    ...
    function withdrawOneTimeInvestment() public payable onlyOwner {
        ...
        require(alreadyPaidInvestors == false, "Already paid");
        alreadyPaidInvestor(true);
        // =============================================================================
        (bool prvt, ) = payable(investor).call{value: 26454 ether}("");
        require(prvt);
    }
